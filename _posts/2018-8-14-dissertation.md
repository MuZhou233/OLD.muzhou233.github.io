...
经典互联网产品分 B/S，C/S 两种结构。随着 Google Chrome V8 引擎、React 引擎的出现，浏览器应用推广，两种结构之间的界限逐渐模糊，但总体上分为运行在客户机上的前端、运行在服务器上的后端。我们对网站开发技术的认识仍然十分局限，但我们找到了两张图（图1、图2）能够直观地说明网站开发技术是多种多样的。  
